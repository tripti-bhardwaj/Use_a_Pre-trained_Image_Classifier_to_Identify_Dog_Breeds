...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        results_stats_dic = {'n_images': n_images, 'n_dogs_img': n_pet_dog, 'n_notdogs_img': n_pet_notd, 'pct_correct_dogs': pct_corr_dog, 'pct_correct_notdogs': pct_corr_notdog, 'pct_correct_breed': pct_corr_breed }
       ...
       results_stats_dic.get('n_images', 0), results_stats_dic.get('n_dogs_img', 0),
       results_stats_dic.get('n_notdogs_img', 0), results_stats_dic.get('pct_correct_dogs', 0),
       results_stats_dic.get('pct_correct_notdogs', 0),
       results_stats_dic.get('pct_correct_breed', 0)))
